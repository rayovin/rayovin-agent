...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\rayovin\rayovin-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@rayovin/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@rayovin/shared': path.resolve(__dirname, '../shared/src'),
