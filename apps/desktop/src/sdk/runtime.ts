 ...
 * plugins resolve `@rayovin/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __RAYOVIN_PLUGIN_SDK__: sdk,
  __RAYOVIN_REACT__: React,
  __RAYOVIN_REACT_JSX__: jsxRuntime,
  __RAYOVIN_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@rayovin/plugin-sdk': shimUrl('__RAYOVIN_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__RAYOVIN_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__RAYOVIN_REACT_JSX__'),
    react: shimUrl('__RAYOVIN_REACT__')
  }
