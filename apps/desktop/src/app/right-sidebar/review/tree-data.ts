import type { RayovinReviewFile } from '@/global'
...
export function buildReviewFlatList(files: RayovinReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: RayovinReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
