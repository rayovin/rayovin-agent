...
const TAKEOVER_KEY = 'rayovin.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Rayovin can't clear via the API — the user
 *  sees exactly what runs instead of Rayovin silently deleting their creds. */
