...
import { getRayovinConfigRecord, listAllProfileSessions } from '@/rayovin'
...
// Rayovin session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getRayovinConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-rayovin',
            keywords: ['update', 'upgrade', 'rayovin', 'version', 'system', 'restart'],
            label: cc.updateRayovin,
