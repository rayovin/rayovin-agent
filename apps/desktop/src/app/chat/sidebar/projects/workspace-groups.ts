...
import type { ProjectInfo, SessionInfo } from '@/rayovin'
 ...
 * repo shows its branches/worktrees even when they have no Rayovin sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: RayovinGitWorktree[]
): SidebarSessionGroup[] {
