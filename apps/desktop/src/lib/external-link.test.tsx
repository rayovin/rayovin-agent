...
const desktopWindow = window as unknown as { rayovinDesktop?: Window['rayovinDesktop'] }
const initialRayovinDesktop = desktopWindow.rayovinDesktop

function installDesktopBridge(partial: Partial<Window['rayovinDesktop']> = {}) {
  desktopWindow.rayovinDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['rayovinDesktop']
}
...
afterEach(() => {
  ...
  if (initialRayovinDesktop) {
    desktopWindow.rayovinDesktop = initialRayovinDesktop
  } else {
    delete desktopWindow.rayovinDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['rayovinDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['rayovinDesktop']['openExternal'] })
