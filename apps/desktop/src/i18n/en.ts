...
export const en: Translations = {
  ...
  boot: {
    ready: 'Rayovin Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Rayovin settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingRayovinDesktop: 'Starting Rayovin Desktop…'
    },
    errors: {
      backgroundExited: 'Rayovin background process exited.',
      backgroundExitedDuringStartup: 'Rayovin background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Rayovin backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateRayovin: 'Update Rayovin',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Rayovin Desktop.',
    ...
    native: {
      ...
      inputBody: 'Rayovin is waiting for your response.',
      turnDoneTitle: 'Rayovin finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Rayovin defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Rayovin writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Rayovin is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Rayovin asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Rayovin was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Rayovin follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Rayovin is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Rayovin, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Rayovin checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Rayovin configuration...',
    ...
    gateway: {
      ...
      intro:
        'Rayovin Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Rayovin backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset RAYOVIN_DESKTOP_REMOTE_URL and RAYOVIN_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Rayovin backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Rayovin backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Rayovin Cloud',
      cloudDesc: 'Sign in once to Rayovin Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Rayovin Cloud',
      cloudSignIn: 'Sign in to Rayovin Cloud',
      cloudSignedIn: 'Signed in to Rayovin Cloud',
      cloudNeedsSignIn: 'Sign in to Rayovin Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Rayovin Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Rayovin Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Rayovin Cloud',
      cloudSignedOutMessage: 'Cleared the Rayovin Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /rayovin.',
      ...
      restartingMessage: 'Rayovin Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Rayovin ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Rayovin runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via rayovin curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Rayovin builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Rayovin to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Rayovin to generate pets.',
      backgroundHint: 'You can close this — Rayovin will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Rayovin desktop' },
    ...
    rayovinActiveSessions: (version, count) => `Rayovin ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@rayovin:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Rayovin environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Rayovin will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Rayovin backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Rayovin. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Rayovin...',
    placeholderReconnecting: 'Reconnecting to Rayovin…',
    ...
    attachUrlDesc: 'Rayovin will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Rayovin to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Rayovin…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Rayovin…',
    ...
    unsupportedMessage: 'This version of Rayovin can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Rayovin from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Rayovin will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Rayovin desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Rayovin updater takes over in its own window and reopens Rayovin automatically when it’s done. Please don’t reopen Rayovin yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Rayovin reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Rayovin reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Rayovin needs a one-time install',
    ...
    settingUpTitle: 'Setting up Rayovin Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Rayovin CLI or desktop instance is running. Stop any running Rayovin instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Rayovin Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Rayovin is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Rayovin…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Rayovin',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Rayovin at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Rayovin connects automatically',
    ...
    authorizeThere: 'Authorize Rayovin there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Rayovin there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Rayovin Desktop v${version}`,
      ...
      gatewayTitle: 'Rayovin inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Rayovin will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Rayovin is restarting...',
      askRestart: 'Ask Rayovin to restart the server',
      lookingRestart: taskId => `Rayovin is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Rayovin is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Rayovin finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Rayovin could not restart the server.',
      stillWorking:
        'Rayovin is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Rayovin is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Rayovin gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.rayovin/config.yaml). Rayovin won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Rayovin needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Rayovin needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Rayovin Desktop to use Save Image.',
    restartToSaveImages: 'Restart Rayovin Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `rayovin gateway` running?'
    }
  },
