...
import type { RayovinGitWorktree, RayovinRepoStatus } from '@/global'
...
export const $repoStatus = atom<RayovinRepoStatus | null>(null)
...
export const $repoWorktrees = atom<RayovinGitWorktree[]>([])
