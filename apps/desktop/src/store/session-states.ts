...
const TILES_KEY = 'rayovin.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'rayovin.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __RAYOVIN_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__RAYOVIN_SESSION_TILES__ = {
