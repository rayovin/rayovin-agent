...
export interface PetInfo {
  ...
  // the Rayovin "run" activity state uses the in-place running row).
 ...
 * RAYOVIN_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'rayovin.desktop.pet-roam.v1'
