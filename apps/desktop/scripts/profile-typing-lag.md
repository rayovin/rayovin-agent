...
cd apps/desktop
XCURSOR_SIZE=24 RAYOVIN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/rayovin-typing
# → /tmp/rayovin-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/rayovin-typing.before.heapsnapshot
# → /tmp/rayovin-typing.after.heapsnapshot
```
