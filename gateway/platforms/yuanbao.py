...
_APP_VERSION = _RAYOVIN_VERSION
_BOT_VERSION = _RAYOVIN_VERSION
_YUANBAO_INSTANCE_ID = str(RAYOVIN_INSTANCE_ID)  # single source: yuanbao_proto.RAYOVIN_INSTANCE_ID
