...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$RAYOVIN_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_rayovin_dir("platforms/whatsapp/session", "whatsapp/session")
