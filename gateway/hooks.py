...
Hooks are discovered from ~/.rayovin/hooks/ directories, each containing:
...
HOOKS_DIR = get_rayovin_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"rayovin_hook_{hook_name}"
