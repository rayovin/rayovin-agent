import { Box, type ScrollBoxHandle, stringWidth, Text } from '@rayovin/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (RAYOVIN_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (RAYOVIN_DEV_CREDITS), lowest priority,
