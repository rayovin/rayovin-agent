 ...
 *
 * Symptom: in `rayovin --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@rayovin/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using rayovin --tui and as i type multiline my caret at the end will often ' +
