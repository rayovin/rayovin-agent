...
import type { ScrollBoxHandle } from '@rayovin/ink'
import { evictInkCaches } from '@rayovin/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.RAYOVIN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
