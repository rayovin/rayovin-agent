...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "github.com/rayovin/rayovin-agent"
...
def auth_json_path():
    """Return the Rayovin auth store path, respecting RAYOVIN_HOME overrides."""
    return get_rayovin_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`rayovin tools`, banner/status paint, provider
