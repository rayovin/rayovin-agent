...
Trust levels:
  - builtin:   Ships with Rayovin. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.rayovin/\.env|\~/\.rayovin/\.env',
     "rayovin_env_access", "critical", "exfiltration",
     "directly references Rayovin secrets file"),
    ...
    (r'\.rayovin/config\.yaml|\.rayovin/SOUL\.md',
     "rayovin_config_mod", "critical", "persistence",
     "references Rayovin configuration files directly"),
...
# scan. `.skillignore` is the Rayovin-native name; `.clawhubignore` is honored
