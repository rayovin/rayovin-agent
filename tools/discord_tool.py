...
Only included in the rayovin-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Rayovin-Agent (https://github.com/NousResearch/rayovin-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_rayovin_home() / "cache" / "discord_capabilities.json"
