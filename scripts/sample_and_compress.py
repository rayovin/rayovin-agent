...
DEFAULT_DATASETS = [
    ...
    "NousResearch/rayovin-agent-megascience-sft1",
    "NousResearch/Rayovin-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Rayovin-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-rayovin-agent"
]
