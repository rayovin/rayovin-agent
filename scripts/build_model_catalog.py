#!/usr/bin/env python3
"""Build the Rayovin Model Catalog — a centralized JSON manifest of curated models.
...
Rayovin CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Rayovin release.
...
# Ensure RAYOVIN_HOME is set for imports that touch it at module level.
os.environ.setdefault("RAYOVIN_HOME", os.path.join(os.path.expanduser("~"), ".rayovin"))

from rayovin_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Rayovin '
