...
AUTHOR_MAP = {
    ...
    "shannon@rayovin.com": "shannonsands",
    ...
    "rayovin@rayovin.com": "NousResearch",
    ...
    "clement@rayovin.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "annguyen@rayovin.com": "annguyenNous",  # PR #52844 co-author
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "rayovin@rayovin.com"}
