...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Rayovin\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@github.com/rayovin/rayovin-agent",
    "cursoragent@cursor.com",
    "rayovin@github.com/rayovin/rayovin-agent",
    "rayovin-audit@example.com",
    "rayovin@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/rayovin-agent",
                "--state", "merged",
