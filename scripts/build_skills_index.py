#!/usr/bin/env python3
"""Build the Rayovin Skills Index — a centralized JSON catalog of all skills.
...
`rayovin skills search/install` can use it without hitting the GitHub API.
...
# Ensure RAYOVIN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Rayovin Skills Index...", flush=True)
