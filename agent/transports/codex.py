...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Rayovin's web-provider config and
        ...
        # native search engine for xAI sessions instead of Rayovin's
        # configured web provider (Tavily/etc.), and those results bypass
        # Rayovin's tool-trace / citation plumbing (they arrive baked into the
