...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``rayovin logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Rayovin only initiates compaction in "rayovin" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Rayovin preflight compression for codex app-server "
                "(mode=%s); Rayovin will not start thread compaction here.",
