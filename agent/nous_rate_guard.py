...
(3 SDK retries x 3 Rayovin retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_rayovin_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".rayovin")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Rayovin, ...) behind one endpoint.  A 429 can mean either:
