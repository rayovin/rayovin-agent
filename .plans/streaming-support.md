# Streaming LLM Response Support for Rayovin Agent
...
```
RAYOVIN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("RAYOVIN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `rayovin_cli/config.py` | 1 | +streaming config defaults |
...
RAYOVIN_STREAMING_ENABLED=true
```
