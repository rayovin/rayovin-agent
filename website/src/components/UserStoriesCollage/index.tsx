  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Rayovin Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Rayovin &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Rayovin?{' '}
        <a
          href="https://github.com/NousResearch/rayovin-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/NousResearch" target="_blank" rel="noopener noreferrer">
          نبض آینده جنوب (Nabz-e-Ayandeh-e-Jonoob) Discord
        </a>{' '}
