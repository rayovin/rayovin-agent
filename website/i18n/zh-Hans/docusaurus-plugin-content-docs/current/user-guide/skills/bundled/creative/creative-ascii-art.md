...
```bash
python3 -m pyfiglet "RAYOVIN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=RAYOVIN&font=Slant" | boxes -d stone
```
