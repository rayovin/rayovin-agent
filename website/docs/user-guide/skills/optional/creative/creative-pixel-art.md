...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.rayovin/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.rayovin/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Rayovin installs package this)
