...
- User wants **Rayovin itself to drive a browser** → use Rayovin' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
