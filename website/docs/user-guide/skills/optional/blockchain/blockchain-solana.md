...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Rayovin Agent |
| License | MIT |
...
Helper script path: ~/.rayovin/skills/blockchain/solana/scripts/solana_client.py
