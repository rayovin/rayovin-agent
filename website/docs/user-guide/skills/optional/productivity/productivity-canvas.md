...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Rayovin Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${RAYOVIN_HOME:-~/.rayovin}/.env`:
