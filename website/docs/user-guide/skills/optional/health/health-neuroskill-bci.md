...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/health/neuroskill-bci` |
...
Connect Rayovin to a running [NeuroSkill](https://neuroskill.com/) instance to read
