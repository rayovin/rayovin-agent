...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Rayovin Agent |
| License | MIT |
...
import upstream classes into Rayovin itself.
...
Open `~/.rayovin/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Rayovin core.
   Custom driver scripts under `~/.rayovin/skills/...` are user-side and fine.
