...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/research/qmd` |
...
Rayovin Agent via the native MCP client. This is the preferred
...
Then configure Rayovin Agent to connect via HTTP:
