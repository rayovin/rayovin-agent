...
| | |
|---|---|
| Source | Optional — install with `rayovin skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Rayovin Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $RAYOVIN_OSINT_CACHE/icij/ (default: ~/.cache/rayovin-osint/icij/).
...
# Set RAYOVIN_OSINT_UA=your-app/1.0 (your@email) to identify yourself
