...
[Download the Rayovin Desktop installer](https://rayovin-agent.rayovin.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.rayovin.com) account (or sign in), choose the **Free** plan, and authorize Rayovin. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://rayovin-agent.rayovin.com/install.sh), inspect it, then run it.
...
In the browser, create a [Nous Portal](https://portal.rayovin.com) account (or sign in) and choose the **Free** plan.
