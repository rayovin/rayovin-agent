...
const STORAGE_KEY = "rayovin-dashboard-theme";
...
const FONT_STORAGE_KEY = "rayovin-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `rayovin_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "rayovin-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-rayovin-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-rayovin-theme-font", "true");
