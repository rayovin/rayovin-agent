 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `rayovin_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Rayovin Teal",
  description: "Classic dark teal — the canonical Rayovin look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Rayovin Teal (Large)",
  description: "Rayovin Teal with bigger fonts and roomier spacing",
