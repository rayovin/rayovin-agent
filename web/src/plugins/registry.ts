 ...
 *
 * Plugins call window.__RAYOVIN_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__RAYOVIN_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__RAYOVIN_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__RAYOVIN_PLUGIN_SDK__ = {
    ...
    // window.__RAYOVIN_SESSION_TOKEN__ directly.
    authedFetch,
