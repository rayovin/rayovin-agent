 ...
 * `window.__RAYOVIN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Rayovin brand in the top bar
 ...
 *  `window.__RAYOVIN_PLUGINS__.registerSlot(...)`.
 *
