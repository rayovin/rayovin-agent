/**
 * Rayovin Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__RAYOVIN_PLUGIN_SDK__`` and
 * ``window.__RAYOVIN_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__RAYOVIN_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``RayovinPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@rayovin/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__RAYOVIN_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__RAYOVIN_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__RAYOVIN_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface RayovinPluginSDK {
...
declare global {
  interface Window {
    __RAYOVIN_PLUGIN_SDK__?: RayovinPluginSDK;
    __RAYOVIN_PLUGINS__?: PluginRegistry;
  }
}
