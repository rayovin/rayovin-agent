...
export const en: Translations = {
  ...
  app: {
    ...
    footer: {
      org: "نبض آینده جنوب (Nabz-e-Ayandeh-e-Jonoob)",
    },
  ...
  status: {
    ...
    updateRayovinConfirmMessage:
      "This runs rayovin update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateRayovinConfirmNow: "Update now",
    updateRayovinConfirmTitle: "Update Rayovin?",
    updatingRayovin: "Updating Rayovin…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Rayovin plugins (`rayovin plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.rayovin/plugins/?",
    removeHint: "Only user-installed plugins under ~/.rayovin/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.rayovin/skills/",
  ...
  config: {
    configPath: "~/.rayovin/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Rayovin doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Rayovin Achievements",
      subtitle:
        "Collectible Rayovin badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Rayovin session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Rayovin more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Rayovin sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Rayovin is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Rayovin Agent ☤",
    },
  },
