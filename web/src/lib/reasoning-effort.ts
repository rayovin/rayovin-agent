 ...
 *
 * Values mirror rayovin_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Rayovin default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Rayovin' default when unset). */
