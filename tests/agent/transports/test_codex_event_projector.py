"""Tests for CodexEventProjector — codex item/* events → Rayovin messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Rayovin' message alternation invariant."""
