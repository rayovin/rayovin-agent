...
thinking phase.  Rayovin's default cloud-stream stale detector
(``RAYOVIN_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``RAYOVIN_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
