...
def worker_loop(worker_id: int, rayovin_home: str, result_file: str) -> None:
...
def reclaimer_loop(rayovin_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="rayovin_mixed_stress_")
    print(f"RAYOVIN_HOME = {home}")
