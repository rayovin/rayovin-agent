...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("RAYOVIN_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("RAYOVIN_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("RAYOVIN_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
