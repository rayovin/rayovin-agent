"""Tests for _setup_feishu() in rayovin_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("rayovin_cli.config.save_env_value", side_effect=mock_save), \
         patch("rayovin_cli.config.get_env_value", side_effect=mock_get), \
         patch("rayovin_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("rayovin_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("rayovin_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("rayovin_cli.cli_output.print_header"), \
         patch("rayovin_cli.cli_output.print_info"), \
         patch("rayovin_cli.cli_output.print_success"), \
         patch("rayovin_cli.cli_output.print_warning"), \
         patch("rayovin_cli.cli_output.print_error"), \
