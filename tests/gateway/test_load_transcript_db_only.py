...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.rayovin/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at rayovin_state import time, before pytest's RAYOVIN_HOME monkeypatch
    fires — the autouse fixture's RAYOVIN_HOME override doesn't help here.)
    """
