...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("rayovin_cli.config.get_config_path", return_value=config_path), \
             patch("rayovin_cli.config.ensure_rayovin_home"):
    ...
    def test_ensure_rayovin_home_sets_0700(self):
        home = Path(self.tmpdir) / ".rayovin"
