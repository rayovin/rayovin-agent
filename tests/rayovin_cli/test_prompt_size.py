"""Tests for the ``rayovin prompt-size`` diagnostic (issue #34667)."""
...
from rayovin_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(rayovin_home, memory_text="", user_text=""):
    mem_dir = rayovin_home / "memories"
...
def _seed_skill(rayovin_home, name, description):
    skill_dir = rayovin_home / "skills" / "demo" / name
