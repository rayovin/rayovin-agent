...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from rayovin_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in RAYOVIN_OVERLAYS
        overlay = RAYOVIN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify rayovin doctor recognizes Xiaomi env vars."""
