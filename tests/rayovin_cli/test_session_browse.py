"""Tests for the interactive session browser (`rayovin sessions browse`).
...
from rayovin_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """rayovin sessions browse should be parseable."""
