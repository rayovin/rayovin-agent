...
The notice prints the most recent curator run summary on `rayovin update`,
...
session start) so users normally never see the rename map. `rayovin update`
