"""Tests for the specifier module + `rayovin kanban specify` CLI surface.
...
from rayovin_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `rayovin kanban …` argparse surface directly."""
