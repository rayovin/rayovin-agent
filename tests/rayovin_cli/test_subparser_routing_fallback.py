...
The main() function in rayovin_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `rayovin -c model`
...
def _build_parser():
    """Build a minimal replica of the rayovin top-level parser."""
