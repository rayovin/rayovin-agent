...
The unit tests in tests/rayovin_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned rayovin-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/rayovin")
from rayovin_cli.service_manager import S6ServiceManager
