...
def test_import_loads_env_from_rayovin_home(tmp_path, monkeypatch):
    home = tmp_path / ".rayovin"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-rayovin-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-rayovin-home"
