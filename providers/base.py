...
def _profile_user_agent() -> str:
    """Return a ``rayovin-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from rayovin_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"rayovin-cli/{_ver}"
    except Exception:
        return "rayovin-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # rayovin-cli UA so the catalog endpoint is reachable.
