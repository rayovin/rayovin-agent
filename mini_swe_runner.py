#!/usr/bin/env python3
"""
SWE Runner with Rayovin Trajectory Format

A runner that uses Rayovin-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Rayovin-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Rayovin-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Rayovin format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Rayovin-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Rayovin-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Rayovin Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Rayovin-Agent's built-in execution environments
    and outputs trajectories in Rayovin-Agent format.
    """
    ...
    def _convert_to_rayovin_format(
        self,
        ...
        """
        Convert internal message format to Rayovin trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Rayovin trajectory format
        trajectory = self._convert_to_rayovin_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Rayovin trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Rayovin Trajectory Format")
    print("=" * 60)
