...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Rayovin gateway adapter.

    Each inbound phone number gets its own Rayovin session (multi-tenant).
...
# static dict in rayovin_cli/gateway.py, and the _send_sms dispatch in
