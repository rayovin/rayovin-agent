...
Config: ~/.rayovin/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.rayovin/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_rayovin_home()`` helper (RAYOVIN_HOME-aware and
...
RULES_FILE = get_rayovin_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_rayovin_home() / "feishu_comment_pairing.json"
