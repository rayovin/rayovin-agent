...
required — uses aiohttp which is already a Rayovin dependency.
...
def interactive_setup() -> None:
    ...
    ``rayovin_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Rayovin delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # rayovin_cli/setup.py::_setup_mattermost function.
