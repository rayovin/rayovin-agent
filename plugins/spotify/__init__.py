...
``_check_spotify_available()`` — when the user has not run ``rayovin auth
spotify``, the tools remain registered (so they appear in ``rayovin
...
The Spotify auth flow (``rayovin auth spotify``), CLI plumbing, and docs
