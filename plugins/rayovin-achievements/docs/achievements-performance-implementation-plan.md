# Rayovin Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.rayovin/plugins/rayovin-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.rayovin/plugins/rayovin-achievements/scan_checkpoint.json`.
