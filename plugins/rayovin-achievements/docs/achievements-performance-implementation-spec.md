# Rayovin Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.rayovin/plugins/rayovin-achievements/state.json` (existing unlock state)
  - `~/.rayovin/plugins/rayovin-achievements/scan_snapshot.json` (new)
  - `~/.rayovin/plugins/rayovin-achievements/scan_checkpoint.json` (new)
