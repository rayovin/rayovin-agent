...
Usage:
    rayovin pairing list              # Show all pending + approved users
    rayovin pairing approve <platform> <code>  # Approve a pairing code
    rayovin pairing revoke <platform> <user_id> # Revoke user access
    rayovin pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle rayovin pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: rayovin pairing {list|approve|revoke|clear-pending}")
        print("Run 'rayovin pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.rayovin/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'rayovin pairing list' to see pending codes.\n")
