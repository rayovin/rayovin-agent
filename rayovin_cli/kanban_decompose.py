...
Invoked by ``rayovin kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Rayovin Agent board.
...
def _profile_author() -> str:
    """Mirror of ``rayovin_cli.kanban._profile_author``."""
    return (
