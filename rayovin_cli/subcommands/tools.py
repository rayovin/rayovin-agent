"""``rayovin tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'rayovin tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # rayovin tools list [--platform cli]
    ...
    # rayovin tools disable <name...> [--platform cli]
    ...
    # rayovin tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `rayovin tools` runs after you pick a provider that\n"
