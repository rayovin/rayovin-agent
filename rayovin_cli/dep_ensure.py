...
def _has_rayovin_agent_browser() -> bool:
    ...
    # install.sh installs globally into $RAYOVIN_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-RayovinHome", str(get_rayovin_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = rayovin_subprocess_env(inherit_credentials=False)
