"""
Rayovin CLI - Unified command-line interface for Rayovin Agent.

Provides subcommands for:
- rayovin chat          - Interactive chat (same as ./rayovin)
- rayovin gateway       - Run gateway in foreground
- rayovin gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `rayovin setup` on a fresh Pi.
    ...
    rayovin_cli/stdio.py::configure_windows_stdio() runs later from the entry
