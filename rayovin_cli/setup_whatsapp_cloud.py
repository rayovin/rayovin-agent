...
Entry point: ``rayovin whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``rayovin_cli/main.py``).
...
Rayovin gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Rayovin to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Rayovin needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Rayovin gateway in another terminal:")
    print("         rayovin gateway")
    print()
    ...
    print()
    print("  Docs: https://rayovin.github.io/rayovin-agent/user-guide/")
