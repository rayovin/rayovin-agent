"""Client for uploading ``rayovin debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``rayovin debug share``.
...
_USER_AGENT = "rayovin-agent/debug-share"
