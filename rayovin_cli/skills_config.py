"""
Skills configuration for Rayovin Agent.
`rayovin skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.rayovin/config.yaml under:
...
from rayovin_cli.config import cfg_get, load_config, save_config
from rayovin_cli.colors import Colors, color
from rayovin_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `rayovin skills`."""
    from rayovin_cli.curses_ui import curses_checklist
