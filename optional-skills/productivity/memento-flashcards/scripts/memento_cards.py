...
Data file: $RAYOVIN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_RAYOVIN_HOME = Path(os.environ.get("RAYOVIN_HOME", Path.home() / ".rayovin"))
DATA_DIR = _RAYOVIN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
